  ...
  return (
    <div>
      ...
      <div className="p-6 lg:py-12">
        <div className=" lg:px-12 grid lg:grid-cols-2 gap-6 w-full px-6 ">
          <div className="pt-8">
            <motion.div
              className="bg-gradient-to-b from-[#9F09BD] to-[#F2AEFF] rounded-xl p-3 lg:w-full max-h-[250px] min-h-[250px] w-full text-white relative overflow-hidden"
              whileHover="hover"
              initial="rest"
              animate="rest"
            >
          ...
          <div className="pt-8">
            <motion.div
              className="bg-[#002F61] rounded-xl p-3 lg:w-full max-h-[250px] min-h-[250px] w-full text-white relative overflow-hidden"
              whileHover="hover"
              initial="rest"
              animate="rest"
            >
